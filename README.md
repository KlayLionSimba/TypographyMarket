...
최초 폰트 및 캘리그래프등을 등록 하면 라이선스 구매 마켓에서 발행한 수익금을 배당 받을수 있는 권리를 가질수 있는
1)NFT 토큰을 민팅하여 토큰을 발행힙니다. 발행된 토큰은 오픈 마켓에서 거래될수 있으며 홀더에게는 라이선스 판매 마켓에서 발행한 수익을 
DAO 트레져리로 부터 배당 받을수 있습니다.
